...
$script = "
	...
	function menuHide(val)
	{
		if ( val == '-')
		{
			...
			jQuery('#menuselect-group').removeClass();
			jQuery('#menuselect-group').show();
			jQuery('#menuselect-group').addClass('control-group menuselect-input-check selectall');
		} else if (val == 1) {
			jQuery('#menuselect-group').removeClass();
			jQuery('#menuselect-group').show();
			jQuery('#menuselect-group').addClass('control-group menuselect-input-check selectitem');
		} else if (val == -1) {
			jQuery('#menuselect-group').removeClass();
			jQuery('#menuselect-group').show();
			jQuery('#menuselect-group').addClass('control-group menuselect-input-check selectiteminvert');
		}
		else 
		{
			jQuery('#menuselect-group').removeClass();
			jQuery('#menuselect-group').addClass('control-group menuselect-input-check');
			jQuery('#menuselect-group').show();
		}
	}
";
