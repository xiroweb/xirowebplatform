...
<?php if ($tmplurl) : ?>
		<?php $toolbar = JModuleHelper::getModules('toolbar');
			if ($toolbar) : ?>		
			<div class="row-bs3">
				<div class="col-xs-12">	
						<?php
						// Display the submenu position modules
						foreach ($toolbar as $module)
						{
...
<form action="<?php echo JRoute::_('index.php?option=com_modules&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="module-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			...
			<div class="span4">
				<fieldset class="form-vertical">
					...
					<div class="control-group form-depth">
						<div class="text-center">
							<span>
								<img width="100" src="<?php echo  JUri::base() . '/templates/xiroadmin/images/web-design.png'; ?>" />
							</span>
						</div>
				...
				<?php if ($this->item->client_id == 0) : ?>
					<div class="form-depth form-vertical">
						<div class="text-center">
							<span><i class="menu-menus fa fa-sitemap fa-4x"></i></span>
						</div>
		...
		<?php if ($tmplurl) :
			$urlreutrn = JUri::base() . 'index.php?option=com_modules&tmpl=component';
			$urlreutrn .= ($roottemplate ? '&roottemplate=' . $roottemplate : '');
			$urlreutrn .= ($templateStyle ? '&templateStyle=' . $templateStyle : '');
			?>
		<input type="hidden" name="return" value="<?php echo base64_encode($urlreutrn); ?>" />
		<?php endif; ?>
