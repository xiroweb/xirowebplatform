				...
				<tbody>
					<?php foreach ($this->items as $i => $item) : ?>
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->parent_id; ?>" item-id="<?php echo $item->id ?>" parents="<?php echo $parentsStr ?>" level="<?php echo $item->level ?>">
							...
							<td class="categories-group-title">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									...
									<a class="hasTooltip categories-item-title" href="<?php echo JRoute::_('index.php?option=com_categories&task=category.edit&id=' . $item->id . '&extension=' . $extension); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
										<?php echo $this->escape($item->title); ?></a>
								<?php else : ?>
									<i class="fa fa-fw fa-folder-open"></i>
									<span class="categories-item-title"><?php echo $this->escape($item->title); ?></span>
								<?php endif; ?>
