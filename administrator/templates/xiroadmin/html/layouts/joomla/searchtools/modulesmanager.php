...
if (isset($data['view']->filterForm) && !empty($data['view']->filterForm))
{
	...
	unset($data['view']->activeFilters['position']);
...
<div class="js-stools clearfix">
	...
	<?php endif; ?>
	<?php if ($data['options']['showSelector'] && !JFactory::getApplication()->input->get('tmpl', '', 'STRING')) : ?>
		<div class="js-stools-container-selector">
			<?php echo JLayoutHelper::render('joomla.searchtools.modulesmanager.selector', $data); ?>
		</div>
	<?php endif; ?>
</div>
