...
<?php if (!empty($filters['filter_position'])) : ?>
	<?php $dataShowOn = " data-showon='" . json_encode(JFormHelper::parseShowOnConditions($filters['filter_position']->showon, $filters['filter_position']->formControl, $filters['filter_position']->group)) . "'"; ?>
	<div class="js-stools-field-filter"<?php echo $dataShowOn; ?>>
		<?php // echo $filters['filter_position']->input; ?>
		<?php  echo JLayoutHelper::render('joomla.searchtools.modulesmanager.getpositions', array('data' => $data, 'selectposition' => $filters['filter_position']->value )); ?>
	</div>
<?php endif; ?>	
