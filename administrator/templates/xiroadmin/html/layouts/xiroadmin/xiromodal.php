...
if (!isset($displayData['params']['height'])) {
	$displayData['params']['height'] = '1000px';
}
if (!isset($displayData['params']['width'])) {
	$displayData['params']['width'] = '90';
}
if (!isset($displayData['params']['bodyHeight'])) {
	$displayData['params']['bodyHeight'] = '99';
}
if (!isset($displayData['params']['modalWidth'])) {
	$displayData['params']['modalWidth'] = '90';
}
...
if (isset($params['modalxiro']) && ($params['modalxiro']) )
{
	JHtml::_('stylesheet', 'modal.css', array('version' => 'auto', 'relative' => true));
	$modalClasses[] = 'modaltopview';
