...
class JoomlaupdateModelDefault extends JModelLegacy
{
	...
	public function applyUpdateSite()
	{
		...
		switch ($params->get('updatesource', 'nochange'))
		{
			...
			case 'sts':
			case 'next':
				$updateURL = 'https://update.xiroweb.com/core/sts/list_sts.xml';
				break;

			// "Testing"
			case 'testing':
				$updateURL = 'https://update.xiroweb.com/core/test/list_test.xml';
				break;
			 ...
			 */
			default:
				$updateURL = 'https://update.xiroweb.com/core/list.xml';
		}
